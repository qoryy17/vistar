                    ...
                    <div>
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{ route('customer.get-sertikom', ['category' => 'workshop']) }}">Workshop
                                </a>
                            </li>
                            ...
                            <div class="card-body">
                                @if ($participant == null)
                                    ...
                                    <div class="alert alert-primary" role="alert" style="text-align: justify;">
                                        Saat ini kamu dalam proses pendaftaran peserta workshop
                                ...
                                @else
                                    @if ($currentStep->tahapan == 'Proses')
                                        ...
                                        <div class="alert alert-warning" role="alert" style="text-align: justify;">
                                            Saat ini workshop sedang berlangsung. Sertifikat kehadiran akan tersedia diunduh
                                            setelah workshop telah dilaksanakan !
                                        @elseif ($currentStep->tahapan == 'Selesai')
                                            <div class="alert alert-success mb-0" role="alert">
                                                <h5 class="alert-heading">Unduh Sertifikat Kamu</h5>
                                                <p>
                                                    Selamat kamu telah selesai mengikuti workshop
                                                    "{{ $sertikom->produk }}".
                                            ...
                                            <a href="{{ route('customer.get-certificate-sertikom', ['category' => 'workshop', 'id' => Crypt::encrypt($participant->id), 'param' => 'null']) }}"
