                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($transactions as $row)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($row->status_order === 'pending' && $row->snap_token)
                                                            ...
                                                            <button onclick="showSnap('{{ $row->snap_token }}')"
                                                                id="pay-button"
                                                                class="mt-3 btn btn-sm btn-block btn-warning text-nowrap">
                                                        ...
                                                        @if ($row->status_order === 'paid')
                                                            <a href="{{ route('customer.get-sertikom', ['category' => 'workshop']) }}"
                                                                type="submit"
                                                                class="btn btn-sm btn-primary d-block d-md-inline-block text-nowrap">
                                                    ...
                                                    <td>
                                                        Rp.
                                                        {{ is_numeric($row->total) ? Number::Format($row->total, 0) : '-' }}
                                                    </td>
                                                    <td>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <p style="text-align: justify">
                                        Hallo <strong>"{{ Auth::user()->name }}"</strong> "Belum daftar workshop? Tambah
                                        wawasan Anda dan temukan inspirasi baru bersama para ahli! Segera bergabung untuk
