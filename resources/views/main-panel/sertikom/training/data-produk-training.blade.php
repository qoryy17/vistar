                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                ...
                                <div class="row p-3">
                                    <div class="col-md-12">
                                        <a href="{{ route('sertikom.form', ['param' => 'add', 'id' => Crypt::encrypt('null'), 'category' => 'pelatihan']) }}"
                                            class="btn btn-sm btn-default btn-web">
                                            <i class="fa fa-plus"></i> Tambah Produk Pelatihan
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($sertikom as $row)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($checkOrder)
                                                            <a href="{{ route('sertikom.training-detail', ['id' => Crypt::encrypt($row->id), 'category' => 'pelatihan']) }}"
                                                                title="Detil" class="btn btn-success btn-sm">
                                                                <i class="fa fa-search"></i>
                                                            </a>
                                                        @endif
                                                        <a href="{{ route('sertikom.form', ['param' => 'edit', 'id' => Crypt::encrypt($row->id), 'category' => 'pelatihan']) }}"
                                                        ...
                                                        <form id="delete-form{{ $no }}"
                                                            action="{{ route('sertikom.training-delete', ['id' => Crypt::encrypt($row->id)]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
