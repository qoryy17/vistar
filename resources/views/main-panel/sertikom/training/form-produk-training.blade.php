                ...
                <div class="row sidemenu-height">
                    <div class="col-lg-12">
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <form action="{{ route('sertikom.training-save') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="NamaPelatihan">Nama Pelatihan <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" class="form-control" placeholder="Nama Pelatihan..."
                                                    autocomplete="off" required
                                                    value="{{ $sertikom ? $sertikom->produk : old('NamaPelatihan') }}"
                                                    id="NamaPelatihan" name="NamaPelatihan">
                                                @error('NamaPelatihan')
