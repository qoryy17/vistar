                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card overflow-hidden custom-card ">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('sertikom.product', ['category' => 'seminar']) }}"
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <h5 class="p-3 m-0">
                                    Tahapan Proses Seminar : @if ($currentStep == null)
                                        <span class="text-primary">Belum Dimulai</span>
                                    @elseif($currentStep == 'Proses')
                                        <span class="text-primary">Seminar Sedang Berlangsung</span>
                                    @elseif($currentStep == 'Selesai')
                                        <span class="text-primary">Seminar Telah Berakhir</span>
                                    @endif
                                </h5>
                                @if ($currentStep == null)
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <p style="text-align: justify;">
                                            ...
                                            Tahapan ini dibuat apabila seminar segera dimulai, dan status produk
                                            pada seminar akan berubah menjadi <strong>"Sold Out"</strong>
                                        </p>
                                    </div>
                                @endif
                                @error('Tahapan')
                                ...
                                <div class="p-3 m-0">
                                    ...
                                    <form id="delete-form"
                                        action="{{ route('sertikom.delete-step', ['id' => Crypt::encrypt($sertikom->id), 'category' => 'seminar']) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Tahapan Seminar</h6>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group" hidden>
                                                        <input type="text" value="{{ Crypt::encrypt('Seminar') }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form id="delete-participant{{ $no }}"
                                                                action="{{ route('sertikom.delete-participant', ['id' => Crypt::encrypt($row->id), 'category' => 'seminar', 'idSertikom' => Crypt::encrypt($sertikom->id)]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
