                ...
                <div class="row sidemenu-height">
                    <div class="col-lg-12">
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <form action="{{ route('sertikom.seminar-save') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="NamaSeminar">Nama Seminar <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" class="form-control" placeholder="Nama Seminar..."
                                                    autocomplete="off" required
                                                    value="{{ $sertikom ? $sertikom->produk : old('NamaSeminar') }}"
                                                    id="NamaSeminar" name="NamaSeminar">
                                                @error('NamaSeminar')
