                                ...
                                <div class="row p-3">
                                    <div class="col-md-12">
                                        <button type="button" data-bs-target="#modalPrint" data-bs-toggle="modal"
                                            ...
                                            <i class="fa fa-print"></i> Cetak List Order
                                        </button>
                                        ...
                                        <!-- Print modal -->
                                        <form action="{{ route('sertikom.export-to-pdf') }}" method="GET">
                                            @csrf
                                            @method('GET')
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="tanggalAwal">Tanggal Awal
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="tanggalAkhir">Tanggal Akhir
                                                                            <span class="tx-danger">*</span>
                                                                        </label>
                                                                        <input class="form-control"
                                                            ...
                                                            <div class="form-group" hidden>
                                                                ...
                                                                <input class="form-control" placeholder="Kategori"
                                                                    type="text" id="kategori" required
                                        ...
                                        <!-- End Print modal -->
                                        <!-- Excel modal -->
                                        <form action="{{ route('sertikom.export-to-excel') }}" method="GET">
                                            @csrf
                                            @method('GET')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p>
                                                            ...
                                                            Produk : <strong>{{ $row->produk }}</strong> <br>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('sertikom.detail-order', ['id' => $row->id]) }}"
