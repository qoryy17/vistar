                    ...
                    <div>
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('sertikom.list-order', ['category' => $category]) }}">{{ $bc1 }}</a>
                            </li>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <td>Referensi Order Produk</td>
                                            <td>{{ $detilOrder->ref_order_id }}</td>
                                        </tr>
                                        <tr>
                                            <td>Nama Produk</td>
                                            <td>{{ $detilOrder->produk }}</td>
                                        </tr>
                                        <tr>
                                ...
                                <a href="{{ route('sertikom.list-order', ['category' => $category]) }}"
