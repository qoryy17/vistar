                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="row p-3">
                                    <div class="col-md-12">
                                        <a href="{{ route('sertikom.expertise-form', ['param' => 'add', 'id' => Crypt::encrypt('null')]) }}"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($expertise as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('sertikom.expertise-form', ['param' => 'edit', 'id' => Crypt::encrypt($row->id)]) }}"
                                                        ...
                                                        <form id="delete-form{{ $no }}"
                                                            action="{{ route('sertikom.expertise-delete', ['id' => Crypt::encrypt($row->id)]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
