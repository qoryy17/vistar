                            ...
                            <div class="card-body">
                                <div class="row p-3">
                                    <div class="col-md-12">
                                        ...
                                        <a href="{{ route('exam-special.products') }}" class="btn btn-sm btn-warning">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($participants as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a title="Detail {{ $row->nama }}"
                                                            class="btn btn-sm btn-primary"
                                                            href="{{ route('exam-special.participants-detail', ['id' => Crypt::encrypt($row->customer_id)]) }}">
                                                        ...
                                                        <form id="delete-form{{ $no }}"
                                                            action="{{ route('exam-special.delete', ['id' => Crypt::encrypt($row->customer_id), 'param' => Crypt::encrypt('all')]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
