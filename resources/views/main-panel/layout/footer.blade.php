...
<script src="{{ asset('resources/spruha/assets/plugins/wysiwyag/jquery.richtext.js') }}"></script>
...
<script src="{{ asset('resources/spruha/assets/plugins/jquery.maskedinput/jquery.maskedinput.js') }}"></script>
...
<script src="{{ asset('resources/spruha/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.js') }}"></script>

<!-- Internal Sweet-Alert js-->
<script src="{{ asset('resources/spruha/assets/plugins/sweet-alert/sweetalert.min.js') }}"></script>

{{-- Vi Star Custom JS --}}
<script src="{{ asset('resources/spruha/assets/js/vistar.js') }}"></script>
