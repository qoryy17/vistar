                                        ...
                                        <tr class="shop-list">
                                            ...
                                            <td style="justify-items: center;">
                                                <div class="d-flex flex-nowrap gap-1">
                                                    ...
                                                    <a href="{{ route('orders.sertikom-payment', ['params' => Crypt::encrypt($row->id), 'category' => 'pelatihan']) }}"
                                                        class="btn btn-pills btn-soft-primary">
                                                        Bayar <i class="mdi mdi-cash-sync"></i>
                                                    </a>
                                                </div>
                                                <form id="formHapusItem{{ $no }}"
                                                    action="{{ route('mainweb.cart-sertikom-delete', ['id' => Crypt::encrypt($row->id), 'category' => 'pelatihan']) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                            ...
                            <div class="card blog blog-primary rounded border-0 shadow overflow-hidden" itemscope
                                ...
                                <div class="card-body content">
                                    ...
                                    <div itemscope itemprop="review" itemtype="https://schema.org/Review">
                                        ...
                                        <meta itemprop="reviewBody" content="Pelatihan berbasis online terbaik." />
                                    </div>
                                </div>
                            </div>
                        </div>
