...
@section('content')
    <section class="section" style="margin-top: 50px;">
        <div class="container">
            ...
            <form action="{{ route('mainweb.product-sertikom', ['category' => 'seminar']) }}" method="GET">
                <div class="row">
                    <div class="col-md-4 mb-2">
                        <div class="form-group">
                            <label for="searchExpertise">Pilih Topik Seminar</label>
                            <select name="expertise_id" class="form-control" id="searchExpertise">
                                <option value="">-- Pilih Topik Seminar --</option>
                    ...
                    <div class="col-md-5 mb-2">
                        <div class="form-group">
                            <label for="searchName">Cari Seminar</label>
                            <input type="text" autocomplete="off" placeholder="Cari Seminar..." id="searchName"
                ...
                @if ($products->isEmpty())
                    <div class="col-lg-12 col-md-12 mt-4 pt-2">
                        <div class="alert bg-soft-warning fw-medium fade show" role="alert">
                            ...
                            <strong>Informasi</strong> Maaf Seminar Tidak Ditemukan...!!!
                        </div>
                    </div>
                @else
