                                        ...
                                        <tr class="shop-list">
                                            ...
                                            <td style="justify-items: center;">
                                                <div class="d-flex flex-nowrap gap-1">
                                                    ...
                                                    <a href="{{ route('orders.sertikom-payment', ['params' => Crypt::encrypt($row->id), 'category' => 'seminar']) }}"
                                                        class="btn btn-pills btn-soft-primary">
                                                        Bayar <i class="mdi mdi-cash-sync"></i>
                                                    </a>
                                                </div>
                                                <form id="formHapusItem{{ $no }}"
                                                    action="{{ route('mainweb.cart-sertikom-delete', ['id' => Crypt::encrypt($row->id), 'category' => 'seminar']) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                            <div class="card blog blog-primary rounded border-0 shadow overflow-hidden" itemscope
                                ...
                                <div class="card-body content">
                                    ...
                                    <a itemprop="url" href="{{ $url }}" title="Lihat Seminar {{ $row->produk }}"
