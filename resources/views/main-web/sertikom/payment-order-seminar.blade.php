                    ...
                    <div class="col-12">
                        ...
                        <div class="table-responsive bg-white shadow rounded">
                            <table class="table mb-0 table-center">
                                <thead>
                                    <tr>
                                        <th class="border-bottom text-start" style="min-width: 300px;">Seminar/Workshop</th>
                                ...
                                <tbody>
                                    <tr class="shop-list">
                                        <td class="text-start" style="vertical-align: top;">
                                            ...
                                            <h5 class="mt-3 fs-6">Jadwal Seminar/Workshop</h5>
                                        ...
                                        <td class="text-start" style="vertical-align: top;">
                                            <h5 class="fs-6">Benefit Seminar</h5>
                                            @php
