...
<head>
    ...
    <!-- Css -->
    <link href="{{ url('resources/web/dist/assets/libs/tiny-slider/tiny-slider.css') }}" rel="stylesheet">
    <link href="{{ url('resources/web/dist/assets/libs/tobii/css/tobii.min.css') }}" rel="stylesheet">
    <link href="{{ url('resources/web/dist/assets/libs/swiper/css/swiper.min.css') }}" rel="stylesheet">
    <!-- Bootstrap Css -->
    ...
    <link href="{{ url('resources/web/dist/assets/libs/@iconscout/unicons/css/line.css') }}" type="text/css"
        rel="stylesheet">
    <!-- Style Css-->
    <link href="{{ url('resources/web/dist/assets/css/select2.min.css') }}" id="color-opt" class="theme-opt"
        rel="stylesheet" type="text/css">
