<x-web.header-auth :title="'Vi Star Indonesia | Pembayaran Berhasil'" />
<!-- Hero Start -->
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="text-center">
                    ...
                    <h1 class="my-4 fw-bold">Pembayaran Berhasil</h1>
                    <p class="text-muted para-desc mx-auto">Terimakasih telah melakukan pembayaran, kini anda dapat
