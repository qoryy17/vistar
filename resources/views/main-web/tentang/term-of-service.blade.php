                            ...
                            <div>
                                ...
                                <p>
                                    Dengan mengakses situs web <a title="{{ $web->nama_bisnis }}"
                                        ...
                                        style="color: black; text-decoration: none;">{{ route('mainweb.index') }}</a>, Anda
                                ...
                                <ol>
                                    <li>
                                        ...
                                        perangkat lunak) di situs web {{ $web->nama_bisnis }} hanya untuk melihat sementara,
                                        ...
                                        <ol>
                                            ...
                                            <li>berupaya mendekompilasi atau merekayasa balik perangkat lunak apa pun yang
                                                terdapat di situs web {{ $web->nama_bisnis }};</li>
                                            <li>menghapus hak cipta atau notasi kepemilikan lainnya dari materi; atau
                                            </li>
                                            <li>mentransfer materi ke orang lain atau "mirror" materi di server lain.</li>
                                        </ol>
                                    </li>
                                    <li>
                                        ...
                                        saja. Setelah
                                        mengakhiri penayangan materi ini atau setelah penghentian lisensi ini, Anda harus
                                ...
                                <ol>
                                    <li>
                                        ...
                                        adanya'. {{ $web->nama_bisnis }} tidak membuat jaminan, tersurat maupun tersirat,
                                        dan dengan ini menafikan dan
                                        meniadakan semua jaminan lainnya termasuk, tanpa batasan, jaminan tersirat atau
                                        ketentuan yang dapat diperjualbelikan, kesesuaian untuk tujuan tertentu, atau tidak
                                        melanggar hak kekayaan intelektual atau pelanggaran hak lainnya.
                                    </li>
                                    <li>
                                        Lebih lanjut, {{ $web->nama_bisnis }} tidak menjamin atau membuat pernyataan apa pun
                                        terkait
                                        keakuratan, kemungkinan hasil, atau keandalan penggunaan materi di situs webnya atau
                                        yang terkait dengan materi tersebut atau di situs mana pun yang terhubung ke situs
                                        ini.
                                    </li>
                                </ol>
